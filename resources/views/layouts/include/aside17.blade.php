    ...
    <nav class="navigation">
        ...
        @if(Auth::user()->type == 'admin')
            <li class="has-submenu"><a href="{{ route('usutut.index')  }}"><i class="ion-ios-people"></i> <span class="nav-label">Coordinadores</span><span class="badge bg-success">Nuevo</span></a></li>            
        @endif
