                ...
                <div class="portlet">
                    <div class="portlet-heading bg-info">
                        <h3 class="portlet-title">
                            Modificando la sesión de Tutoria individual
                        </h3>
                    ...
                    <div id="portlet-2" class="panel-collapse collapse in">
                        ...
                        {!! Form::open(['route' => ['sesindi17.update', $sesindi17], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    {!! Form::textarea('pro_ide', $sesindi17->pro_ide, ['class' => 'form-control', 'placeholder' => 'Ingrese OTROS problemas identificados por el estudiante', 'style' => 'display: none;', 'id' => 'pro_ide']) !!}
...
@section('js')
    <script type="text/javascript">
        $(document).on('ready', function(){ 
            ...
            $('#div-pro_ide').summernote("code", $("#pro_ide").val());
