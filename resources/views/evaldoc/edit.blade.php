@extends('layouts.app')
@section('title', 'Editar Evaluación del Tutor')
...
@section('content')
	{!! Form::open(['route' => ['evaldoc.update', $evaldoc], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
					...
					<tbody>
						@foreach ($itemevaldocs as $itemevaldoc)
							<tr>
								...
								<td>
									{!! Form::select('evaldoc_item['.$itemevaldoc->id.']', ['1' => 'NUNCA', '2' => 'RARA VEZ', '3' => 'FRECUENTEMENTE', '4' => 'CASI SIEMPRE', '5' => 'SIEMPRE'], $evaldoc_item[$itemevaldoc->id], ['class' => 'form-control', 'required']) !!} 
								</td>
							</tr>
						@endforeach
					</tbody>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				{!! Form::textarea('obs_sug', $evaldoc->obs_sug, ['class' => 'form-control area-content', 'placeholder' => 'Ingrese sus Observaciones o sugerencia', 'required', 'size' => '50x3']) !!}
			</div>
		</div>
