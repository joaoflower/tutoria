@extends('layouts.app')
@section('title', 'Editar Informe técnico académico del tutor')
...
@section('content')
	{!! Form::open(['route' => ['itadoc.update', $itadoc], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				{!! Form::select('mesita_id', $mesitas, $itadoc->mesita_id, ['class' => 'form-control select-estudiante', 'required', 'data-placeholder' => 'Seleciones Turorado']) !!}
			</div>
		</div>
		<div class="form-group">
			{!! Form::label('fecha', 'Fecha :', ['class' => 'col-md-2 control-label']) !!}
			<div class="col-md-9">
				{!! Form::input('date','fecha', $itadoc->fecha, ['class' => 'form-control fechas', 'required', 'placeholder' => 'aaaa-mm-dd']) !!}
			</div>
		</div>
					...
					<tbody>
						@foreach ($dificultads as $dificultad)
							<tr>
								...
								<td>
									{!! Form::select('itadoc_dific['.$dificultad->id.']', ['SI' => 'SI', 'NO' => 'NO'], $itadoc_dific[$dificultad->id], ['class' => 'form-control', 'required']) !!}
								</td>
							</tr>
						@endforeach
					</tbody>
		...
		<div class="form-group">
			...
			<div class="col-md-10">
				...
				{!! Form::select('res_dif', ['SI' => 'SI', 'NO' => 'NO', 'PARCIALMENTE' => 'PARCIALMENTE'], $itadoc->res_dif, ['class' => 'form-control select-estudiante', 'required', 'data-placeholder' => 'Seleciones Turorado']) !!}
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-1"></div>
					...
					<tbody>
						@foreach ($avanceacas as $avanceaca)
							<tr>
								...
								<td>
									{!! Form::select('itadoc_avaca['.$avanceaca->id.']', ['SI' => 'SI', 'NO' => 'NO', 'REGULAR' => 'REGULAR'], $itadoc_avaca[$avanceaca->id], ['class' => 'form-control', 'required']) !!}
								</td>
							</tr>
						@endforeach
					</tbody>
					...
					<tbody>
						@foreach ($avancepess as $avancepes)
							<tr>
								...
								<td>
									{!! Form::select('itadoc_avpes['.$avancepes->id.']', ['SI' => 'SI', 'NO' => 'NO', 'REGULAR' => 'REGULAR'], $itadoc_avpes[$avancepes->id], ['class' => 'form-control', 'required']) !!}
								</td>
							</tr>
						@endforeach
					</tbody>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				{!! Form::textarea('rec_sug', $itadoc->rec_sug, ['class' => 'form-control area-content', 'placeholder' => 'Recomendaciones y Sugenrencias', 'required', 'size' => '50x3']) !!}
			</div>
		</div>
