@extends('layouts.app')
@section('title', 'Agregar Informe técnico académico del tutorando')
...
@section('content')
	{!! Form::open(['route' => 'itaestu.store', 'method' => 'POST', 'class' => 'form-horizontal']) !!}
					...
					<tbody>
						@foreach ($dificultads as $dificultad)
							<tr>
								...
								<td>
									{!! Form::select('itaestu_dific['.$dificultad->id.']', ['SI' => 'SI', 'NO' => 'NO'], null, ['class' => 'form-control', 'required']) !!}
								</td>
							</tr>
						@endforeach
					</tbody>
					...
					<tbody>
						@foreach ($avanceacas as $avanceaca)
							<tr>
								...
								<td>
									{!! Form::select('itaestu_avaca['.$avanceaca->id.']', ['SI' => 'SI', 'NO' => 'NO', 'REGULAR' => 'REGULAR'], null, ['class' => 'form-control', 'required']) !!}
								</td>
							</tr>
						@endforeach
					</tbody>
					...
					<tbody>
						@foreach ($avancepess as $avancepes)
							<tr>
								...
								<td>
									{!! Form::select('itaestu_avpes['.$avancepes->id.']', ['SI' => 'SI', 'NO' => 'NO', 'REGULAR' => 'REGULAR'], null, ['class' => 'form-control', 'required']) !!}
								</td>
							</tr>
						@endforeach
					</tbody>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				{!! Form::textarea('rec_sug', null, ['class' => 'form-control area-content', 'placeholder' => 'Recomendaciones y Sugenrencias', 'required', 'size' => '50x3']) !!}
			</div>
		</div>
