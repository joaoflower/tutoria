...
@section('content')
	...
	<p>El Estudiante {{ $estudiante->paterno }} {{ $estudiante->materno }}, {{ $estudiante->nombres }}  ha cumplido con las actividades programadas de tutoría en el semestre académico 2018-I, en concordancia al Reglamento y Normatividad del “Sistema de Tutoría Universitaria”, (aprobado según Resolución Rectoral Nº 1415-2015-R-UNA). </p>
