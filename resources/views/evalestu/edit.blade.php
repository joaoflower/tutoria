@extends('layouts.app')
@section('title', 'Editar Evaluación del Estudiante Tutorado')
...
@section('content')
	{!! Form::open(['route' => ['evalestu.update', $evalestu], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
					...
					<tbody>
						@foreach ($itemevalestus as $itemevalestu)
							<tr>
								...
								<td>
									{!! Form::select('evalestu_item['.$itemevalestu->id.']', ['1' => 'NUNCA', '2' => 'RARA VEZ', '3' => 'FRECUENTEMENTE', '4' => 'CASI SIEMPRE', '5' => 'SIEMPRE'], $evalestu_item[$itemevalestu->id], ['class' => 'form-control', 'required']) !!}
								</td>
							</tr>
						@endforeach
					</tbody>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				{!! Form::textarea('obs_sug', $evalestu->obs_sug, ['class' => 'form-control area-content', 'placeholder' => 'Ingrese sus Observaciones o sugerencia', 'required', 'size' => '50x3']) !!}
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-md-6 col-md-offset-4">
				{!! Form::button('<span class="glyphicon glyphicon-floppy-save"></span> Editar Evaluación', ['type' => 'submit', 'class' => 'btn btn-success']) !!}	
