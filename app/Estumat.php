...
class Estumat extends Model
{
    ...
    public static function getEstumats($cod_car) {
        ...
        if($cod_car == '88') {
            return DB::connection('unapnet')
                ...
                ->whereIn('estumat2016all.niv_est', ['01'])
                ->whereIn('estumat2016all.cod_car', ['16', '17'])   
                ->where('estumat2016all.per_aca', $per_aca)          
                ->orderBy('paterno', 'asc')
                ->get();
        }
        elseif($cod_car == '01') {
    ...
    public static function getRegulares($cod_car) {
        ...
        return DB::connection('unapnet')
            ...
            ->leftjoin('unapnet.estudiante', 'estumat2016all.num_mat', '=', 'estudiante.num_mat')
            ->select('estudiante.num_mat', 'estudiante.cod_car', 'paterno', 'materno', 'nombres')
            ->whereIn('estumat2016all.niv_est', ['02','03', '04','05','06','07','08','09','10','11','12'])
            ->where('estumat2016all.cod_car', $cod_car)  
            ->where('estumat2016all.per_aca', $per_aca)           
            ->orderBy('paterno', 'asc')
            ->get();
